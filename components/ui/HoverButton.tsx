        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    "text-[#f5f5f5] font-bold text-[11px] tracking-[0.2em] uppercase",
                    "whitespace-nowrap", // ADDED to prevent text wrapping on smaller buttons
                    "backdrop-blur-lg bg-[rgba(43,55,80,0.1)]",
                    "cursor-pointer overflow-hidden flex items-center justify-center gap-2",
                ...
                {...props}
                style={{
                    "--circle-start": "var(--tw-gradient-from, #c9a84c)",
                    "--circle-end": "var(--tw-gradient-to, #b8860b)",
            ...
            >
                ...
                {/* z-10 ensures text and icons stay above the glowing particles */}
